...
```bash
find /var/www/html//laravel/Modules -path "*/Filament/*/Pages/*.php" | grep -v "Page.php$"
```
...
- [Modules/Notify/docs/FILAMENT_PAGE_NAMING_CONVENTION.md](file:///var/www/html//laravel/Modules/Notify/docs/FILAMENT_PAGE_NAMING_CONVENTION.md)
